...
class SessionApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun enableSession(uuid: kotlin.String, body: kotlin.String?) : Unit {
        val localVariableConfig = enableSessionRequestConfig(uuid = uuid, body = body)
    ...
    * @return RequestConfig
    */
    fun enableSessionRequestConfig(uuid: kotlin.String, body: kotlin.String?) : RequestConfig {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun revertIdentity(uuid: kotlin.String, body: kotlin.String?) : Session {
        val localVariableConfig = revertIdentityRequestConfig(uuid = uuid, body = body)
    ...
    * @return RequestConfig
    */
    fun revertIdentityRequestConfig(uuid: kotlin.String, body: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
